...
Как игра **усложняется** от матча к матчу, как устроен **турнир на 9 матчей** и что игрок чувствует в **первом матче**.

---

## Целевой масштаб турнира

| Сейчас в коде | Цель дизайна |
|---------------|--------------|
| `matchesToWin = 9` в `GameplaySettings` | **9 побед** на забег (эталон pacing / генерации) |
