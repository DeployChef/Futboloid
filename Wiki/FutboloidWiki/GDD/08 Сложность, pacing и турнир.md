...
|---------------------|--------------|
| `matchesToWin = 3` в `GameplaySettings` | **~10–12 матчей** на полный забег |
...
|----------|----------|
| Полевых | 2–3 |
| Фигура | Простая (треугольник / линия из 3) |
...
Матч 1 **не** участвует в взвешенном рандоме фигур и архетипов.
