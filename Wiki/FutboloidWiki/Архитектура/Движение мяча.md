...
| `PitchStateMachine` | мяч **не симулирует отскоки** в `KickoffWait` / `Reshuffle` (но таймер **идёт** на Reshuffle); пауза только `Navigation.Pause` |
...
- **футболист соперника** — один prefab; режим `Field` (слот + ИИ) или `Goalkeeper` (гипербола) ([[../GDD/07 Противник — вратарь и футболисты|GDD §7]])
