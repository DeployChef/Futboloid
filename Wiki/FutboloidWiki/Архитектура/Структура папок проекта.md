...
Как разложить **Assets** в ФУТБОЛОИД: удобно в редакторе, согласовано с [[DI и LifetimeScope|DI]], [[Сцены и Bootstrap|сценами]] и [[Принципы проектирования|принципами]].
...
└── _Projects/
    ...
    │   ├── Futboloid.Main/            # Bootstrap, GameDirector, AppStates, DI extensions
...
| `Futboloid.Core` | `IGameDirector`, save, executor base, locators | Utilities |
| `Futboloid.UI` | Виджеты, `UIService`, HUD | Core |
| `Futboloid.Gameplay` | Ball, Goalkeeper, MatchFlow, Pitch FSM, боты | Core |
| `Futboloid.Main` | Bootstrap, states, installers, GameDirector | Core, UI, Gameplay |
...
│   └── Events/                  # MatchResetEvent, GoalScoredEvent…
├── Ball/
...
| Файл | Папка | В Build |
|------|-------|---------|
| `Bootstrap.unity` | `_Projects/Scenes/` | ✅ index 0 |
...
Этап 1 из [[Миграция с текущего кода]]: `Futboloid.Main` + `Bootstrap.unity` в `_Projects/Scenes/`.
