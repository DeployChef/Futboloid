...
Архитектура **ФУТБОЛОИД**: bootstrap, VContainer, FSM, оверлеи, **MonoBehaviour + сервисы + шина**, кинематический мяч. См. [[Принципы проектирования]].

## Ключевые решения

| Решение | Почему |
|---------|--------|
| Одна точка входа `Bootstrap` | Единое место инициализации приложения |
...
| **VContainer** + child scopes | Чистый lifecycle: root → session → match |
...
| Заметка | Содержание |
|---------|------------|
| [[Сцены и Bootstrap]] | RootScene, build settings, что где лежит |
...
- **Unity** + URP 2D
- **VContainer** — DI
- **UniTask** — async bootstrap / transitions
