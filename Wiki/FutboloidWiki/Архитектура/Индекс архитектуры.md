...
- [[Аналитика]] — фасад, bridge, каталог v1; SDK → UGS
...
| Audio | [[../Аудио менеджер/аудио менеджер Wiki\|Аудио]] | ✅ `AudioService`, `AudioManager`, `AudioCatalog` |
...
| Analytics | [[Аналитика]] | 🟡 `IAnalyticsService`, `AnalyticsEventBridge` (Debug/Null); UGS 🔲 |
