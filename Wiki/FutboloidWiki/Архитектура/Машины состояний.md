...
1. **App FSM** — bootstrap, загрузка, жизнь приложения
...
|-----------|-------|-----------------|
| **Boot** | `Bootstrap` + `GameStartupHandler` | Старт, guard от двойного init |
...
|-----------|----------|-----|
| `KickoffWait` | Ждём Пробел: ввод мяча; можно двигаться в зоне | §2 старт, §3 |
