...
> [!date] Обновлено
> **04.07.2026** — Fade In/Out, глобальный тумблер, остановка музыки при рестарте.

> [!warning] Важно
> В этой статье описана **текущая** архитектура. История изменений и детали миграции — в [[Контекст/Контекст чата 04.07.2026|Контекст чата]].
