...
namespace Futboloid.Main.Session
{
    ...
    /// </summary>
    public class TournamentRunService : ITournamentBracketReadModel
    {
        ...
        public bool IsChampion => LastMatchWon && MatchesCompleted >= MatchesToWin;
        ...
        private string GetRoundLabel()
        {
            ...
            return $"Матч {MatchesCompleted + 1} из {MatchesToWin}";
        }
